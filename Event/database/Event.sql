...
VALUES
    ('Conferencia sobre Cultura Manga', 'Charla con expertos sobre la evolución del manga.', '2025-03-01 10:00:00', '2025-03-01 12:00:00', ARRAY['url1'], 'poster1', 1, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Taller de Dibujo Manga', 'Aprende técnicas básicas de dibujo manga.', '2025-03-01 13:00:00', '2025-03-01 15:00:00', ARRAY['url2'], 'poster2', 1, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Desfile de Cosplay', 'Competencia de cosplay con premios.', '2025-03-02 10:00:00', '2025-03-02 12:00:00', ARRAY['url3'], 'poster3', 1, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Proyección de Anime Clásico', 'Proyección especial de películas clásicas.', '2025-03-02 14:00:00', '2025-03-02 16:00:00', ARRAY['url4'], 'poster4', 1, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Encuentro con Mangakas', 'Conoce a tus autores favoritos.', '2025-03-03 10:00:00', '2025-03-03 12:00:00', ARRAY['url5'], 'poster5', 1, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Charla sobre Innovación', 'Ideas innovadoras para el futuro.', '2025-03-05 10:00:00', '2025-03-05 11:00:00', ARRAY['url1'], 'poster1', 6, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Mesa Redonda: Sostenibilidad', 'Debate sobre prácticas sostenibles.', '2025-03-05 12:00:00', '2025-03-05 13:30:00', ARRAY['url2'], 'poster2', 6, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Charla Inspiradora', 'Historias personales que inspiran.', '2025-03-06 10:00:00', '2025-03-06 11:30:00', ARRAY['url3'], 'poster3', 6, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Workshop de Liderazgo', 'Taller interactivo para líderes emergentes.', '2025-03-06 12:00:00', '2025-03-06 14:00:00', ARRAY['url4'], 'poster4', 6, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Networking Session', 'Conecta con otros asistentes.', '2025-03-06 15:00:00', '2025-03-06 16:30:00', ARRAY['url5'], 'poster5', 6, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Concierto de Artista A', 'Actuación en vivo de Artista A.', '2025-06-15 18:00:00', '2025-06-15 20:00:00', ARRAY['url1'], 'poster1', 11, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Concierto de Artista B', 'Actuación en vivo de Artista B.', '2025-06-15 21:00:00', '2025-06-15 23:00:00', ARRAY['url2'], 'poster2', 11, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Fiesta Electrónica', 'Sesión de DJ al aire libre.', '2025-06-16 00:00:00', '2025-06-16 02:00:00', ARRAY['url3'], 'poster3', 11, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Taller de Música', 'Aprende sobre producción musical.', '2025-06-16 15:00:00', '2025-06-16 17:00:00', ARRAY['url4'], 'poster4', 11, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Concierto de Clausura', 'Evento de clausura con Artista C.', '2025-06-17 18:00:00', '2025-06-17 20:00:00', ARRAY['url5'], 'poster5', 11, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Partido Inaugural', 'Inicio del torneo.', '2025-06-10 18:00:00', '2025-06-10 20:00:00', ARRAY['url1'], 'poster1', 16, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Semifinal 1', 'Primera semifinal del torneo.', '2025-06-15 18:00:00', '2025-06-15 20:00:00', ARRAY['url2'], 'poster2', 16, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Semifinal 2', 'Segunda semifinal del torneo.', '2025-06-16 18:00:00', '2025-06-16 20:00:00', ARRAY['url3'], 'poster3', 16, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Partido por el Tercer Lugar', 'Disputa del tercer puesto.', '2025-06-19 18:00:00', '2025-06-19 20:00:00', ARRAY['url4'], 'poster4', 16, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Final del Torneo', 'Gran final del torneo mundial.', '2025-06-20 18:00:00', '2025-06-20 20:00:00', ARRAY['url5'], 'poster5', 16, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Plantación de Árboles', 'Actividad principal del día.', '2025-04-01 09:00:00', '2025-04-01 12:00:00', ARRAY['url1'], 'poster1', 21, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Charla Educativa', 'Sensibilización sobre la importancia de los árboles.', '2025-04-01 12:30:00', '2025-04-01 13:30:00', ARRAY['url2'], 'poster2', 21, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Taller de Compostaje', 'Aprende a compostar en casa.', '2025-04-01 14:00:00', '2025-04-01 15:30:00', ARRAY['url3'], 'poster3', 21, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Paseo Guiado', 'Recorrido guiado por el parque.', '2025-04-01 16:00:00', '2025-04-01 17:30:00', ARRAY['url4'], 'poster4', 21, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Cierre con Música', 'Concierto de clausura al aire libre.', '2025-04-01 18:00:00', '2025-04-01 19:30:00', ARRAY['url5'], 'poster5', 21, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
END
$do$;
...
VALUES
    ('Presentación de Mascotas', 'Conoce a las mascotas disponibles para adopción.', '2025-04-10 10:00:00', '2025-04-10 11:30:00', ARRAY['subevent1.jpg'], 'poster1.jpg', 1, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Charla sobre Tenencia Responsable', 'Aprende cómo cuidar a tu nueva mascota.', '2025-04-10 12:00:00', '2025-04-10 13:00:00', ARRAY['subevent2.jpg'], 'poster2.jpg', 1, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Taller para Niños: Cuida a tu Mascota', 'Actividad educativa para los más pequeños.', '2025-04-10 14:00:00', '2025-04-10 15:30:00', ARRAY['subevent3.jpg'], 'poster3.jpg', 1, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Desfile de Mascotas', 'Evento divertido con premios para mascotas adoptadas.', '2025-04-10 16:00:00', '2025-04-10 17:30:00', ARRAY['subevent4.jpg'], 'poster4.jpg', 1, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Cierre Musical', 'Concierto solidario para finalizar la jornada.', '2025-04-10 18:00:00', '2025-04-10 19:30:00', ARRAY['subevent5.jpg'], 'poster5.jpg', 1, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Introducción a la Tenencia Responsable', 'Conceptos básicos para cuidar a los animales.', '2025-03-10 10:00:00', '2025-03-10 11:00:00', ARRAY['subevent1.jpg'], 'poster1.jpg', 6, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Cuidados Veterinarios Básicos', 'Cómo detectar problemas de salud en mascotas.', '2025-03-10 11:30:00', '2025-03-10 12:30:00', ARRAY['subevent2.jpg'], 'poster2.jpg', 6, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Alimentación Saludable para Mascotas', 'Consejos para una dieta equilibrada.', '2025-03-10 13:00:00', '2025-03-10 14:00:00', ARRAY['subevent3.jpg'], 'poster3.jpg', 6, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Taller Práctico: Higiene Animal', 'Aprende sobre el aseo adecuado.', '2025-03-10 14:30:00', '2025-03-10 15:30:00', ARRAY['subevent4.jpg'], 'poster4.jpg', 6, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Preguntas y Respuestas', 'Resuelve tus dudas con un experto.', '2025-03-10 16:00:00', '2025-03-10 17:00:00', ARRAY['subevent5.jpg'], 'poster5.jpg', 6, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Apertura del Mercadillo', 'Inauguración oficial del evento.', '2025-05-01 10:00:00', '2025-05-01 10:30:00', ARRAY['subevent1.jpg'], 'poster1.jpg', 11, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Zona de Manualidades', 'Compra artículos hechos a mano por voluntarios.', '2025-05-01 10:30:00', '2025-05-01 12:30:00', ARRAY['subevent2.jpg'], 'poster2.jpg', 11, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Rifa Benéfica', 'Participa para ganar premios y ayudar.', '2025-05-01 13:00:00', '2025-05-01 14:00:00', ARRAY['subevent3.jpg'], 'poster3.jpg', 11, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Demostración de Productos Ecológicos', 'Conoce alternativas sostenibles.', '2025-05-01 14:30:00', '2025-05-01 15:30:00', ARRAY['subevent4.jpg'], 'poster4.jpg', 11, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Cierre del Mercadillo', 'Agradecimientos y resumen del evento.', '2025-05-01 16:00:00', '2025-05-01 16:30:00', ARRAY['subevent5.jpg'], 'poster5.jpg', 11, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Inicio de la Caminata', 'Bienvenida y distribución de grupos.', '2025-04-10 09:00:00', '2025-04-10 09:30:00', ARRAY['subevent1.jpg'], 'poster1.jpg', 16, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Parada de Hidratación', 'Descanso y agua para mascotas y dueños.', '2025-04-10 10:30:00', '2025-04-10 10:45:00', ARRAY['subevent2.jpg'], 'poster2.jpg', 16, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Actividades en el Punto Medio', 'Juegos y charlas breves.', '2025-04-10 11:00:00', '2025-04-10 12:00:00', ARRAY['subevent3.jpg'], 'poster3.jpg', 16, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Reanudación de la Caminata', 'Continúa la caminata hasta el punto final.', '2025-04-10 12:15:00', '2025-04-10 13:00:00', ARRAY['subevent4.jpg'], 'poster4.jpg', 16, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Cierre con Reconocimientos', 'Entrega de premios y agradecimientos.', '2025-04-10 13:30:00', '2025-04-10 14:00:00', ARRAY['subevent5.jpg'], 'poster5.jpg', 16, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Registro de Participantes', 'Apertura para registrar a los competidores.', '2025-05-05 08:00:00', '2025-05-05 09:00:00', ARRAY['subevent1.jpg'], 'poster1.jpg', 21, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Ronda Clasificatoria', 'Primera ronda para seleccionar finalistas.', '2025-05-05 09:30:00', '2025-05-05 11:30:00', ARRAY['subevent2.jpg'], 'poster2.jpg', 21, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Pausa y Zona de Relax', 'Espacio para descansar y socializar.', '2025-05-05 12:00:00', '2025-05-05 12:30:00', ARRAY['subevent3.jpg'], 'poster3.jpg', 21, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Ronda Final', 'Los mejores competidores se enfrentan.', '2025-05-05 13:00:00', '2025-05-05 14:30:00', ARRAY['subevent4.jpg'], 'poster4.jpg', 21, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Entrega de Premios', 'Premiación y cierre del evento.', '2025-05-05 15:00:00', '2025-05-05 15:30:00', ARRAY['subevent5.jpg'], 'poster5.jpg', 21, 'Confirmed', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
END
$do$;
