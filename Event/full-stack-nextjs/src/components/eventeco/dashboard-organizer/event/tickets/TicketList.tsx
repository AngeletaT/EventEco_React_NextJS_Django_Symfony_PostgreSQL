...
import { useTickets, useCreateTicket } from "@/hooks/eventeco/useTickets";
...
const TicketList = ({ eventSlug }: { eventSlug: string }) => {
    ...
    return (
        <div className={styles.ticketContainer}>
            ...
            <Button label="Crear Nuevo Ticket" icon="pi pi-plus" className="p-button-success" onClick={handleCreateTicket} />
