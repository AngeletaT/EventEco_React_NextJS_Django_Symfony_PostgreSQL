...
import { useComplements, useCreateComplement } from "@/hooks/eventeco/useComplements";
...
const ComplementList = ({ eventSlug }: { eventSlug: string }) => {
    ...
    return (
        <div className={styles.complementContainer}>
            ...
            <Button label="Crear Nuevo Complemento" icon="pi pi-plus" className="p-button-success" onClick={handleCreateComplement} />
