...
import { useCreateOrder } from "@/hooks/pawnity/useOrders";
import { useSelector } from "react-redux";
import { RootState } from "@/store/pawnity";
import { Elements, CardElement, useStripe, useElements } from "@stripe/react-stripe-js";
import { processStripePayment } from "@/services/pawnity/command/order/processPayment";
import { sendWhatsapp } from "@/services/pawnity/command/tickets/sendNotifications";
...
const PaymentForm: React.FC<{
    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            console.log("Order tickets:", order.ticketunits);
            const paymentBody = {
