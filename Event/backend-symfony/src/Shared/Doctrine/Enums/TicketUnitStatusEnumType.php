...
/**
 * Custom Doctrine type for the ticketUnitStatusEnum ENUM.
 */
class TicketUnitStatusEnumType extends Type
{
    public const NAME = 'ticketUnitStatusEnum';
    ...
    public function convertToPHPValue($value, AbstractPlatform $platform): mixed
    {
        if (!in_array($value, self::VALUES, true)) {
            throw new \InvalidArgumentException("Invalid value for 'ticketUnitStatusEnum' ENUM: $value");
        }
