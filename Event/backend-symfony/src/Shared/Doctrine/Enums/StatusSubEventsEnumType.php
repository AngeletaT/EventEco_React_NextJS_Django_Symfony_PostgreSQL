...
/**
 * Custom Doctrine type for the statusSubEvents ENUM.
 */
class StatusSubEventsEnumType extends Type
{
    public const NAME = 'statusSubEvents';
    ...
    public function convertToPHPValue($value, AbstractPlatform $platform): mixed
    {
        if (!in_array($value, self::VALUES, true)) {
            throw new \InvalidArgumentException("Invalid value for 'statusSubEvents' ENUM: $value");
        }
