...
/**
 * Custom Doctrine type for the notificationStatus ENUM.
 */
class NotificationStatusEnumType extends Type
{
    public const NAME = 'notificationStatus';
    ...
    public function convertToPHPValue($value, AbstractPlatform $platform): mixed
    {
        if (!in_array($value, self::VALUES, true)) {
            throw new \InvalidArgumentException("Invalid value for 'notificationStatus' ENUM: $value");
        }
