...
class P_ProfileClientMeView(APIView):
     ...
     def get(self, request):
          ...
          profile, created = P_ProfileClient.objects.get_or_create(
               idclient=idclient,
...
class P_ProfileClientUpdateView(APIView):
     ...
     @swagger_auto_schema(
          ...
          responses={200: P_ProfileClientSerializer(), 400: "Datos inválidos", 401: "No autenticado", 404: "Perfil no encontrado"}
     )
