...
class E_ClientManager(BaseUserManager):
     """
     Manager personalizado para manejar la creación de clientes de Eventeco.
     """
...
class E_Client(AbstractBaseUser, PermissionsMixin):
     """
     Modelo de cliente para Eventeco.
     """
     ...
     def __str__(self):
          return f"{self.email} - Eventeco Client"
